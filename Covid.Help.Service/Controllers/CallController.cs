        ...
        public ContentResult InitCall(CallApiRequest callApiRequest)
        {
            var callApiResponse = new CallApiResponse
            {
                Say = new CallSayApiResponse
                {
                    ...
                    Value = callApiRequest.From + "Olá. Olá. Olá. Eu sou a Vivi, sua assistente virtual. Fui desenvolvida para ajudar na triagem dos casos do Corona vírus, assim como passar algumas informações que podem ser de grande ajuda. Espero ajudar de alguma forma."
                }
            };
